...
import static org.arabeyes.itl.hijri.HijriModule.fill_datestruct;
import static org.arabeyes.itl.hijri.HijriModule.g_day;
import static org.arabeyes.itl.hijri.HijriModule.g_day_short;
import static org.arabeyes.itl.hijri.HijriModule.g_month;
import static org.arabeyes.itl.hijri.HijriModule.g_month_short;
import static org.arabeyes.itl.hijri.HijriModule.h_day;
import static org.arabeyes.itl.hijri.HijriModule.h_day_short;
...
class UmmAlquraModule {
     ...
     */
    private static int Hsub2G(sDate mydate, int mh, int yh) {
        int flag;
        int JD;
        double GJD;
     ...
     * and returns flag found:1 not found:0
     */
    static int G2H(sDate mydate, int dg, int mg, int yg) {
        int yh2, mh2;
        int df;
        int flag = 1;
        int J;
        double GJD, HJD;
        final sDate tmpdate = new sDate();
        final sDate tmpdate2 = new sDate();
        /*int error_fill;*/
     ...
     */
    static int H2G(sDate mydate, int dh, int mh, int yh) {
        int found, yh1, mh1;
        /*int error_fill;*/
        final sDate tmpdate = new sDate();
     ...
     */
    private static double JDToGCalendar(double JD, sDate mydate) {
        double A, B, F;
        int alpha, C, E;
        int D, Z;
     ...
     */
    private static void GDateAjust(sDate mydate) {
        int dys;
     ...
     */
    private static void JDToHCalendar(double JD, sDate mydate) {
